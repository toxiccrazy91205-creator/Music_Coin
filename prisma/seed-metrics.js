...
async function main() {
    ...
    if (!existingTicket) {
        await prisma.ticket.create({
            data: {
                ...
                seatNumber: "A1",
                tier: "VIP",
                price: new client_2.Prisma.Decimal(50),
                status: "SOLD"
            }
        });
    ...
    if (!existingSoldNft) {
        const nft = await prisma.nFT.create({
            data: {
                ...
                ownerId: fanUser.id,
                price: new client_2.Prisma.Decimal(250),
        ...
        if (fanWallet && artistWallet && orgWallet) {
            await prisma.transaction.create({
                data: {
                    ...
                    amount: new client_2.Prisma.Decimal(25),
            ...
            await prisma.transaction.create({
                data: {
                    ...
                    amount: new client_2.Prisma.Decimal(50),
    ...
    if (fanWallet && Number(fanWallet.stakedBalance) === 0) {
        await prisma.wallet.update({
            ...
            data: { stakedBalance: new client_2.Prisma.Decimal(500) }
        });
